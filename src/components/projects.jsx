						...
						<div className="row">
								...
								<div className="project" style={{backgroundImage: 'url(images/project/reactlogo.png)'}}>
									<div className="desc">
										<div className="con">
											...
											<p className="icon">
												<span><a href="#" target="_blank" ref="noreferrer"><i className="icon-share3" /></a></span>
											</p>
										</div>
									</div>
								</div>
							...
							<div className="col-md-4 animate-box" data-animate-effect="fadeInRight">
								<div className="project" style={{backgroundImage: 'url(images/project/AstronautSpriteSheet210by93.png)'}}>
									<div className="desc">
										<div className="con">
											<h3><a href="https://github.com/rchhatwal3/2D-Game-using-SDL2.0" target="_blank" rel="noreferrer">Moontian - Escape from the Planet</a></h3>
											...
											<p className="icon">
												<span><a href="https://github.com/rchhatwal3/2D-Game-using-SDL2.0" target="_blank" rel="noreferrer"><i className="icon-share3" /></a></span>
											</p>
										</div>
									</div>
								</div>
							...
							<div className="col-md-4 animate-box" data-animate-effect="fadeInTop">
								<div className="project" style={{backgroundImage: 'url(images/project/ppmoutput.png)'}}>
									<div className="desc">
										<div className="con">
											<h3><a href="https://github.com/rchhatwal3/making-ppm-pics-using-shapes" target="_blank" rel="noreferrer">Fun with PPM Images</a></h3>
											...
											<p className="icon">
												<span><a href="https://github.com/rchhatwal3/making-ppm-pics-using-shapes" target="_blank" rel="noreferrer"><i className="icon-share3" /></a></span>
											</p>
										</div>
									</div>
								</div>
							...
							<div className="col-md-4 animate-box" data-animate-effect="fadeInBottom">
								<div className="project" style={{backgroundImage: 'url(images/project/connectx.png)'}}>
									<div className="desc">
										<div className="con">
											<h3><a href="https://github.com/rchhatwal3/ConnectX-Using-Java-Swing" target="_blank" rel="noreferrer">ConnectX Game with GUI</a></h3>
											<span>This was the semester-long project I worked on for my Software Development Foundations class. </span>
											<p className="icon">
												<span><a href="https://github.com/rchhatwal3/ConnectX-Using-Java-Swing" target="_blank" rel="noreferrer"><i className="icon-share3" /></a></span>
											</p>
										</div>
									</div>
								</div>
							...
							<div className="col-md-4 animate-box" data-animate-effect="fadeInLeft">
								<div className="project" style={{backgroundImage: 'url(images/project/gbnprotocol.gif)'}}>
									<div className="desc">
										<div className="con">
											<h3><a href="href=https://github.com/rchhatwal3/GBN-Protocol-Implementation" target="_blank" rel="noreferrer">Go-Back-N Protocol Implementation</a></h3>
											...
											<p className="icon">
												<span><a href="https://github.com/rchhatwal3/GBN-Protocol-Implementation" target="_blank" rel="noreferrer"><i className="icon-share3" /></a></span>
											</p>
										</div>
									</div>
								</div>
							...
							<div className="col-md-4 animate-box" data-animate-effect="fadeInRight">
								<div className="project" style={{backgroundImage: 'url(images/project/simplexmethod.png)'}}>
									<div className="desc">
										<div className="con">
											<h3><a href="https://github.com/rchhatwal3/SimplexMethodCalculator" target="_blank" rel="noreferrer">Simplex Method Calculator</a></h3>
											...
											<p className="icon">
												<span><a href="https://github.com/rchhatwal3/SimplexMethodCalculator" target="_blank" rel="noreferrer"><i className="icon-share3" /></a></span>
											</p>
										</div>
									</div>
								</div>
